...
Forked and optimized by Draikoon.

Native Windows x64 builds are supported with Visual Studio and CMake. See
[WINDOWS.md](WINDOWS.md) or run `powershell -ExecutionPolicy Bypass -File .\build-windows.ps1`.
